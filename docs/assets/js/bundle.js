...
var noteStorage = new Storage("myNote");
...
var addNoteInput = _helper__WEBPACK_IMPORTED_MODULE_2__["domElements"].addNoteInput,
    noteDiv = _helper__WEBPACK_IMPORTED_MODULE_2__["domElements"].noteDiv;
addNoteInput.addEventListener("keyup", function () {
  if (event.keyCode === 13) {
